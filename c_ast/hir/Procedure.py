...
class LeadSpecNotASpecifierError(ProcedureException):
    pass


class BodyNotCompoundStatementError(ProcedureException):
    pass


class NotAParameterDeclaratorError(ProcedureException):
    pass
