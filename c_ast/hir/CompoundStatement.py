...
class CompoundStatementException(Exception):
    pass


class NotAStatementError(CompoundStatementException):
    pass


class StatementNotFoundError(CompoundStatementException):
    pass


class SymbolNotFoundError(CompoundStatementException):
    pass
